...
def evaluate(filename, embedding_weights):
    ...
    for i in data.iloc[:, 0:2].index:
        ...
        if word1 not in word_to_idx or word2 not in word_to_idx:
            ...
            word1_embed, word2_embed = embedding_weights[[word1_idx]], embedding_weights[
                [word2_idx]]
            model_similarity.append(
                float(smp.cosine_similarity(word1_embed, word2_embed)))
...
# 寻找nearest neighbors
for word in ["good", "fresh", "monster", "green", "like", "america", "chicago", "work", "computer",
             "language"]:
